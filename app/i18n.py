...
TEXTS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "hint.installs.fork": "Dieses Repository ist ein Fork und teilt sich die Integrations-Domain mit dem Original. Die Zahl gilt für beide zusammen und fließt deshalb nicht in die Gesamtsumme ein.",
        ...
        "filter.state.tracked": "verfolgt",
        "filter.state.untracked": "nicht verfolgt",
    ...
    "en": {
        ...
        "hint.installs.fork": "This repository is a fork and shares the integration domain with the original. The number covers both, which is why it stays out of the total.",
        ...
        "filter.state.tracked": "followed",
        "filter.state.untracked": "not followed",
        "filter.ha": "Integration",
        "filter.ha.any": "any",
        "filter.ha.yes": "Home Assistant",
        "filter.ha.no": "none",
