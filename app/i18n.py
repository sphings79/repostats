...
TEXTS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "setup.sub": "Dieses Dashboard ist noch offen. Lege das Konto an, bevor es jemand anderes tut.",
        "setup.submit": "Konto anlegen und anmelden",
        "account.title": "Konto",
        "account.sub": "Benutzername und Passwort dieses Dashboards.",
        "account.current": "Aktuelles Passwort",
        "account.new": "Neues Passwort",
        "account.repeat": "Passwort wiederholen",
        "account.others": "Auf allen anderen Geräten abmelden",
        "account.name.title": "Benutzername ändern",
        "account.name.submit": "Namen speichern",
        "account.password.title": "Passwort ändern",
        "account.password.submit": "Passwort speichern",
        "account.done.name": "Benutzername geändert. Angemeldete Geräte mit dem alten Namen sind abgemeldet.",
        "account.done.password": "Passwort geändert.",
        "account.error.name": "Der Benutzername darf nicht leer sein.",
        "account.error.short": "Das Passwort braucht mindestens {n} Zeichen.",
        "account.error.match": "Die beiden Passwörter stimmen nicht überein.",
        "account.error.current": "Das aktuelle Passwort stimmt nicht.",
    ...
    "en": {
        ...
        "setup.title": "Set up the account",
        "setup.sub": "This dashboard is still open. Create the account before somebody else does.",
        "setup.submit": "Create account and sign in",
        "account.title": "Account",
        "account.sub": "The user name and password of this dashboard.",
        "account.current": "Current password",
        "account.new": "New password",
        "account.repeat": "Repeat password",
        "account.others": "Sign out on every other device",
        "account.name.title": "Change the user name",
        "account.name.submit": "Save name",
        "account.password.title": "Change the password",
        "account.password.submit": "Save password",
        "account.done.name": "User name changed. Devices signed in under the old name are signed out.",
        "account.done.password": "Password changed.",
        "account.error.name": "The user name cannot be empty.",
        "account.error.short": "The password needs at least {n} characters.",
        "account.error.match": "The two passwords do not match.",
        "account.error.current": "That is not the current password.",
